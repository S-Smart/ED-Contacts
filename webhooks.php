...
if(($inputtext == "สวัสดี")||($inputtext == "Hi")||($inputtext == "Hello")||($inputtext == "สวัสดีครับ")||($inputtext == "สวัสดีค่ะ")||($inputtext == "อินเตอร์")) {
	...
	$arrPostData['messages'][0]['type'] = 'text';
	$arrPostData['messages'][0]['text'] = "ค้าหาเบอร์ติดต่อของฝ่ายวิศวกรรมและซ่อมบำรุง พิมพ์กลุ่มที่ต้องการหา เช่น Manager  EE  ME  EET\n \nในอนาคตเราจะใช้ช่องทางนี้เพื่ออำนวยความสะดวกให้กับท่าน";
...
} else if (($inputtext == "eet.")||($inputtext == "eet. eng")||($inputtext == "eng eet.")||($inputtext == "EET")||($inputtext == "เทคโนโลยีเครื่องจักร")||($inputtext == "วิศวกรเทคโนโลยีเครื่องจักร")||($inputtext == "ส่วนเทคโนโลยีเครื่องจักร")) {
 	$arrPostData['messages'][0]['type'] = 'text';
